  ...
  return (
    <header className="bg-gradient-to-r from-gray-900 via-gray-700 to-gray-800 text-white shadow-2xl">
      <div className="flex justify-between items-center max-w-6xl mx-auto p-4">
        <NavLink to="/" className="font-bold text-xl flex flex-wrap" end>
          <span className="text-sky-400">Gd</span>
          <span className="text-slate-200">-Groups</span>
        </NavLink>
        <form  onSubmit={handleSubmit} className="bg-gray-800 p-2 rounded-full flex items-center shadow-lg shadow-gray-600">
          <input
            type="text"
            placeholder="Search..."
            value={searchTerm}
