...
export default function CreateListing() {
    return (
        <main className="p-3 max-w-4xl bg-gray-300 rounded-lg shadow-lg mx-auto mt-20"> {/* Added `mt-10` for spacing */}
            ...
            <form className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        ...
                        <button className="p-3 text-purple-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">Upload</button>
                    </div>
