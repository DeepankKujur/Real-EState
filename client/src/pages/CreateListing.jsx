...
export default function CreateListing() {
    return (
        <main className="p-3 max-w-4xl bg-gray-300 rounded-lg shadow-lg mx-auto mt-20">
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <div className="flex flex-col items-start">
                                <label htmlFor="regular-price" className="text-sm">Regular Price</label>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <div className="flex flex-col items-start">
                                <label htmlFor="discount-price" className="text-sm">Discount Price</label>
                                <span className="text-xs">($/month)</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex flex-col flex-1 gap-4">
                    ...
                    <div className="flex gap-4">
                        <input
                            ...
                            multiple
                        />
                        <button className="p-3 text-purple-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">
                            Upload
                        </button>
                    </div>
